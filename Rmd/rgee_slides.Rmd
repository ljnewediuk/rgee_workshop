...
output:
  xaringan::moon_reader:
    ...
    css: [metropolis, metropolis-fonts, "Rmd/css_style.css"]
---
...
- Don't have to save huge raster files to your harddrive

- Don't need to worry about defining projections

- Free access to hundreds (more?) of hdatasets in one place (> 600 as of 2018)
