...
#   
#     Option 1: Initialize Earth Engine and Google Drive (recommend)
      ee_Initialize(user = 'your_email_here@gmail.com', drive = T)
...
#     Option 2: Initialize Earth Engine and Google Cloud Storage
      ee_Initialize(user = 'your_email_here@gmail.com', gcs = T)
